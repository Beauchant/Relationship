...
namespace SMS_ADMIN.ControlDesign
{
    public class CustomDateTimePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Relationship.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Relationship.Properties.Resources.calendarDark;
                else calendarIcon = Relationship.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
